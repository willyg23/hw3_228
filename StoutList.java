...
public class StoutList<E extends Comparable<? super E>> extends AbstractSequentialList<E>
{
  ...
  public NodeInfo find(int pos) {
	  ...
	  // then return nodeInfo on that hoe
...
//	private E currentNode;
	...
	int lastAction; // if next, previous, or nothing was last performed. 1 when next, 0  when previous, -1 when nothing was last performed
